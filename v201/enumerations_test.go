...
func TestAPNAuthenticationEnumTypeUnmarshalJSON(t *testing.T) {
	t.Run("accepts known value", func(t *testing.T) {
		...
		data := fmt.Appendf(nil, `"%s"`, APNAuthenticationEnumTypeCHAP)

		if err := json.Unmarshal(data, &str); err != nil {
			t.Fatalf("unexpected unmarshal error: %v", err)
		}

		if str != APNAuthenticationEnumTypeCHAP {
			t.Errorf("unexpected error\ngot:  %q\nwant: %q", str, APNAuthenticationEnumTypeCHAP)
		}
	})
...
func TestChargingLimitSourceEnumTypeUnmarshalJSON(t *testing.T) {
	t.Run("accepts known value", func(t *testing.T) {
		var str ChargingLimitSourceEnumType
		data := fmt.Appendf(nil, `"%s"`, ChargingLimitSourceEnumTypeEMS)

		if err := json.Unmarshal(data, &str); err != nil {
			t.Fatalf("unexpected unmarshal error: %v", err)
		}

		if str != ChargingLimitSourceEnumTypeEMS {
			t.Errorf("unexpected error\ngot:  %q\nwant: %q", str, ChargingLimitSourceEnumTypeEMS)
		}
	})
...
func TestChargingStateEnumTypeUnmarshalJSON(t *testing.T) {
	t.Run("accepts known value", func(t *testing.T) {
		...
		data := fmt.Appendf(nil, `"%s"`, ChargingStateEnumTypeCharging)

		if err := json.Unmarshal(data, &str); err != nil {
			t.Fatalf("unexpected unmarshal error: %v", err)
		}

		if str != ChargingStateEnumTypeCharging {
			t.Errorf("unexpected error\ngot:  %q\nwant: %q", str, ChargingStateEnumTypeCharging)
		}
	})
...
func TestConnectorEnumTypeUnmarshalJSON(t *testing.T) {
	t.Run("accepts known value", func(t *testing.T) {
		var str ConnectorEnumType
		data := fmt.Appendf(nil, `"%s"`, ConnectorEnumTypeCCCS1)

		if err := json.Unmarshal(data, &str); err != nil {
			t.Fatalf("unexpected unmarshal error: %v", err)
		}

		if str != ConnectorEnumTypeCCCS1 {
			t.Errorf("unexpected error\ngot:  %q\nwant: %q", str, ConnectorEnumTypeCCCS1)
		}
	})
...
func TestEnergyTransferModeEnumTypeUnmarshalJSON(t *testing.T) {
	t.Run("accepts known value", func(t *testing.T) {
		...
		data := fmt.Appendf(nil, `"%s"`, EnergyTransferModeEnumTypeDC)

		if err := json.Unmarshal(data, &str); err != nil {
			t.Fatalf("unexpected unmarshal error: %v", err)
		}

		if str != EnergyTransferModeEnumTypeDC {
			t.Errorf("unexpected error\ngot:  %q\nwant: %q", str, EnergyTransferModeEnumTypeDC)
		}
	})
...
func TestIdTokenEnumTypeUnmarshalJSON(t *testing.T) {
	t.Run("accepts known value", func(t *testing.T) {
		var str IdTokenEnumType
		data := fmt.Appendf(nil, `"%s"`, IdTokenEnumTypeCentral)

		if err := json.Unmarshal(data, &str); err != nil {
			t.Fatalf("unexpected unmarshal error: %v", err)
		}

		if str != IdTokenEnumTypeCentral {
			t.Errorf("unexpected error\ngot:  %q\nwant: %q", str, IdTokenEnumTypeCentral)
		}
	})
...
func TestOCPPTransportEnumTypeUnmarshalJSON(t *testing.T) {
	t.Run("accepts known value", func(t *testing.T) {
		...
		data := fmt.Appendf(nil, `"%s"`, OCPPTransportEnumTypeJSON)

		if err := json.Unmarshal(data, &str); err != nil {
			t.Fatalf("unexpected unmarshal error: %v", err)
		}

		if str != OCPPTransportEnumTypeJSON {
			t.Errorf("unexpected error\ngot:  %q\nwant: %q", str, OCPPTransportEnumTypeJSON)
		}
	})
...
func TestTriggerReasonEnumTypeUnmarshalJSON(t *testing.T) {
	t.Run("accepts known value", func(t *testing.T) {
		...
		data := fmt.Appendf(nil, `"%s"`, TriggerReasonEnumTypeAuthorized)

		if err := json.Unmarshal(data, &str); err != nil {
			t.Fatalf("unexpected unmarshal error: %v", err)
		}

		if str != TriggerReasonEnumTypeAuthorized {
			t.Errorf("unexpected error\ngot:  %q\nwant: %q", str, TriggerReasonEnumTypeAuthorized)
		}
	})
