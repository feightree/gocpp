...
- Reference to any relevant spec section (e.g. `OCPP 1.6 §6.3`, `OCPP 2.0.1 §1.3.1`, or `OCPP 2.1 §1.3.1`).
...
(`v16`), [OCPP 2.0.1](https://openchargealliance.org/protocols/open-charge-point-protocol/#ExploreOCPP2.0.1)
(`v201`), and [OCPP 2.1](https://openchargealliance.org/protocols/open-charge-point-protocol/#ExploreOCPP2.1)
